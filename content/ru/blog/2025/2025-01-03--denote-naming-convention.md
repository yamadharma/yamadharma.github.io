...
-   [Emacs. Пакет denote]({{< relref "../notes/public/20250103T165600--emacs_пакет_denote.md" >}})
...
-   Поле `TITLE` : заголовок заметки, предоставленный пользователем.
    -   По умолчанию он автоматически записывается строчными буквами, через дефис (см. [Соглашения о кодировании]({{< relref "../notes/public/20201220161000-соглашения_о_кодировании.md" >}})).
...
-   Denote может поддерживать концепцию Folgezettel (см. [Нумерация Folgezettel]({{< relref "../notes/public/20250208T161600--нумерация_folgezettel.md" >}})).
...
-   Идея категорий взята из Johnny Decimal ([Система именования каталогов Johnny Decimal]({{< relref "../notes/public/20250711T212200--система_именования_каталогов_johnny_decimal.md" >}}))
