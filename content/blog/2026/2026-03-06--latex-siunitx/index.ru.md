...
lastmod: 2026-04-13T09:44:00+03:00
tags: ["latex"]
...
-   Некоторые полезные опции для `\sisetup`:
    ...
    -   `per-mode = symbol` --- как отображать символ "в минус первой степени": \\(/s\\) вместо \\(s^{-1}\\). Можно также `fraction` для отображения в виде обыкновенной дроби.
