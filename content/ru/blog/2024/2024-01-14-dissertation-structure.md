...
lastmod: 2026-02-28T19:09:00+03:00
tags: ["research"]
categories: ["science"]
draft: false
...
-   Структура диссертации регламентируется стандартом [<a href="#citeproc_bib_item_1">1</a>].
-   Структура диссертации в виде рукописи делится на три блока:
    -   начальный (вводный);
    -   основной (текст работы);
    -   заключительный (справочно-сопроводительный).
-   Их состав:
    -   Титульный лист.
        -   Это первая страница работы.
        -   На нем указываются название организации, тема работы, ФИО автора и руководителя, город и год.
    -   Оглавление (Содержание).
        -   Содержит все заголовки разделов, глав, параграфов и других структурных частей с указанием страниц, с которых они начинаются.
    -   Введение.
        -   Вводный раздел, в котором обосновывается актуальность темы, формулируются цель и задачи, объект и предмет исследования, научная новизна и практическая значимость работы.
    -   Основная часть.
        -   Состоит из нескольких глав, которые делятся на параграфы.
    -   Заключение.
        -   В этом разделе подводятся итоги всей работы, формулируются основные выводы и рекомендации, а также указываются перспективы дальнейшей разработки темы.
    -   Список сокращений и условных обозначений.
        -   Необязательный элемент.
        -   Рекомендуется, если в работе используется много специфических аббревиатур.
    -   Словарь терминов (Глоссарий).
        -   Необязательный элемент.
        -   Приводится, если в диссертации используется узкоспециальная терминология, требующая пояснений .
    -   Список литературы (Библиографический список).
        -   Содержит перечень всех источников, на которые есть ссылки в тексте диссертации .
    -   Список иллюстративного материала.
        -   Необязательный элемент, где перечисляются рисунки, графики, схемы с указанием страниц их размещения.
    -   Приложения.
        -   Завершающий раздел, куда выносятся вспомогательные или дополнительные материалы: объемные таблицы, исходные коды программ, акты внедрения, копии документов и т.д.
...
-   Соответствие между статьёй и диссертацией устанавливается следующим образом [<a href="#citeproc_bib_item_2">2</a>].
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>1.	ГОСТ Р 7.0.11-2011. Система стандартов по информации, библиотечному и издательскому делу. Диссертация и автореферат диссертации. Структура и правила оформления / Утвержден и введен в действие Приказом Федерального агентства по техническому регулированию и метрологии от 13 декабря 2011 г. № 811-ст. Дата введения: 2012-09-01. – Москва : Стандартинформ, 2011. – 16 сс. – Режим доступа: <a href="https://protect.gost.ru/document.aspx?control=7&id=179727">https://protect.gost.ru/document.aspx?control=7&#38;id=179727</a> (дата обращения: 28.02.2026). – [Электронный ресурс].</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>2.	Макаренко, С.И. Оформление и защита кандидатской диссертации по техническим наукам. Т. 1 / С.И. Макаренко. – Санкт-Петербург : Наукоемкие технологии, 2024. – 420 сс. – Режим доступа: <a href="https://publishing.intelgr.com/archive/Oformlenie-i-zashchita-kandidatskoi-dissertatsii-po-tekhnicheskim-naukam-Chast-1.pdf">https://publishing.intelgr.com/archive/Oformlenie-i-zashchita-kandidatskoi-dissertatsii-po-tekhnicheskim-naukam-Chast-1.pdf</a> (дата обращения: 15.02.2025). – [Электронный ресурс].</div>
</div>
