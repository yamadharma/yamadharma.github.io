...
lastmod: 2026-04-07T14:59:00+03:00
...
### <span class="section-num">1.4</span> Содержание для РПД {#содержание-для-рпд}


#### <span class="section-num">1.4.1</span> Понятие протокола. Иерархия протоколов. Интерфейсы и службы. Обмен данными {#понятие-протокола-dot-иерархия-протоколов-dot-интерфейсы-и-службы-dot-обмен-данными}
...
#### <span class="section-num">1.4.2</span> Общие принципы построения модели взаимодействия открытых систем {#общие-принципы-построения-модели-взаимодействия-открытых-систем}
...
#### <span class="section-num">1.4.3</span> Кодирование сигнала, среда передачи, кабельная система, стандарты кабельной системы {#кодирование-сигнала-среда-передачи-кабельная-система-стандарты-кабельной-системы}
...
#### <span class="section-num">1.4.4</span> Протоколы доступа к среде (протокол CSMA, полнодуплексный доступ, маркерное кольцо) {#протоколы-доступа-к-среде--протокол-csma-полнодуплексный-доступ-маркерное-кольцо}
...
#### <span class="section-num">1.4.5</span> Стандарты серии IEEE 802. Подуровни LLC и MAC. Стандарт IEEE 802.2. Форматы кадров {#стандарты-серии-ieee-802-dot-подуровни-llc-и-mac-dot-стандарт-ieee-802-dot-2-dot-форматы-кадров}
...
#### <span class="section-num">1.4.6</span> Метод доступа CSMA/CD, спецификация физической среды. Развитие технологий Ethernet, Fast Ethernet, Gigabit Ethernet. Полнодуплексная передача {#метод-доступа-csma-cd-спецификация-физической-среды-dot-развитие-технологий-ethernet-fast-ethernet-gigabit-ethernet-dot-полнодуплексная-передача}
...
#### <span class="section-num">1.4.7</span> Другие технологии локальных сетей. Технология 100VG--AnyLAN. Token Ring {#другие-технологии-локальных-сетей-dot-технология-100vg-anylan-dot-token-ring}
...
#### <span class="section-num">1.4.8</span> Стек протоколов TCP/IP. Соответствие эталонной модели OSI {#стек-протоколов-tcp-ip-dot-соответствие-эталонной-модели-osi}
...
#### <span class="section-num">1.4.9</span> Сетевой уровень. Протоколы сетевого уровня. Межсетевой уровень стека протоколов TCP/IP. IP, ICMP, ARP {#сетевой-уровень-dot-протоколы-сетевого-уровня-dot-межсетевой-уровень-стека-протоколов-tcp-ip-dot-ip-icmp-arp}
...
#### <span class="section-num">1.4.10</span> Формат кадра IP. IP адресация. Взаимодействие межсетевого уровня с физическим. Фрагментация IP {#формат-кадра-ip-dot-ip-адресация-dot-взаимодействие-межсетевого-уровня-с-физическим-dot-фрагментация-ip}
...
#### <span class="section-num">1.4.11</span> Транспортный уровень. Протоколы TCP, UDP; концепция портов, сессии TCP. Передача пакетов TCP, параметры передачи, MTU, окно. Надёжная доставка {#транспортный-уровень-dot-протоколы-tcp-udp-концепция-портов-сессии-tcp-dot-передача-пакетов-tcp-параметры-передачи-mtu-окно-dot-надёжная-доставка}
