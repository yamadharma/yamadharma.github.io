...
lastmod: 2026-09-22T18:28:00+03:00
tags: ["apartment"]
categories: ["life"]
draft: false
slug: "water-filters"
...
## <span class="section-num">6</span> Конструкция фильтров {#конструкция-фильтров}


### <span class="section-num">6.1</span> Накопительный бак {#накопительный-бак}


#### <span class="section-num">6.1.1</span> Общая информация {#общая-информация}

-   Накопительный бак в системе обратного осмоса (например, в фильтре «Барьер») нужен для запасания очищенной воды.
-   Вода прошла через все ступени фильтрации:
    -   механическую очистку,
    -   угольные картриджи,
    -   обратноосмотическую мембрану,
    -   постфильтр (минерализатор, если есть).

-   Обратноосмотическая мембрана очищает воду очень медленно.
-   Если бы не было бака, при открытии крана была бы тонкая струйка.
-   Бак решает эту проблему:
    -   Пока вы не пользуетесь водой, система потихоньку наполняет бак.
    -   Когда вы открываете кран, вода выталкивается из бака под давлением воздуха --- сразу и с хорошим напором.
    -   В баке обычно хранится 5--12 литров очищенной воды (в зависимости от модели).


### <span class="section-num">6.2</span> Устройство {#устройство}

-   Внутри бака есть резиновая мембрана (груша), которая разделяет пространство на две части:
    -   Внутри груши --- очищенная вода.
    -   Снаружи груши, в корпусе --- воздух под давлением (0,4--0,5 бар).

-   Когда вы открываете кран, воздух давит на грушу и выталкивает очищенную воду наружу.
-   Когда вода заканчивается, давление падает, и система снова начинает медленно наполнять бак.


### <span class="section-num">6.3</span> Неполадки {#неполадки}

-   При выходе воздуха давление падает.
-   Уменьшается напор воды.
-   Если выйдет весь воздух, бак перестанет функционировать.
-   Необходимо удалить всю воду из бака.
    -   Если не течёт, подкачивать понемногу, пока не выльется вся.
-   После этого подкачать давление в баке.


## <span class="section-num">7</span> Опыт эксплуатации {#опыт-эксплуатации}


### <span class="section-num">7.1</span> Фильтр воды Барьер ПРОФИ Осмо 100 М {#фильтр-воды-барьер-профи-осмо-100-м}


#### <span class="section-num">7.1.1</span> Покупка {#покупка}

-
-   Цена: 9990.0₽


#### <span class="section-num">7.1.2</span> Подкачка {#подкачка}

-
-   Уже достаточно давно вода текла тонкой струйкой.
-   Предположил, что надо подкачать бак.
-   Эля попросила электронасос с манометром.
-   При подключении к баку манометр ничего не указывал.
-   Вода из бака не выливалась.
-   Установил на насосе 0.5 бар.
-   Начал подкачивать осторожно.
-   Понемногу стала выталкиваться вода.
-   Сначала каплями.
-   Потом ливанула.
-   Потом стала вытекать самотёком.
-   Вылил всю воду.
-   Подкачал бак до 0.5 бар.
-   Обратно установил в систему.
-   Напор вначале был очень малый.
-   Подождал, пока бак заполнится.
-   Стало литься вполне приемлемо.
