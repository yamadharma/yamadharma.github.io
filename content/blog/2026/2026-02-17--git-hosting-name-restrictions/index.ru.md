...
-   Это часто связано в том числе с необходимостью обеспечивать совместимость с разными операционными системами (см. [Допустимые символы в имени файла]({{< relref "2021-10-17-allowed-characters-filename" >}})).
