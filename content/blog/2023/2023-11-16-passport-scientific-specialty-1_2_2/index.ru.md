---
title: "Паспорт специальности 1.2.2 — Математическое моделирование, численные методы и комплексы программ"
...
-   Фактически, за основу специальности была положена концепция вычислительного эксперимента.
...
## <span class="section-num">7</span> Что не входит в специальность {#что-не-входит-в-специальность}
...
### <span class="section-num">7.1</span> Разработка новых математических моделей из конкретных предметных областей {#разработка-новых-математических-моделей-из-конкретных-предметных-областей}
...
## <span class="section-num">8</span> Количество пунктов паспорта в исследовании {#количество-пунктов-паспорта-в-исследовании}

-   Ранее (в 05.13.18) явно указывалось, что необходимо соответствовать не менее, чем трём пунктам паспорта.
-   В новом варианте (1.2.2) количество пунктов, которым нужно соответствовать, не определяется.
-   Но учитывая явное разделение пунктов но отраслям науки, думаю, достаточно ограничиться двумя пунктами для кандидатской диссертации, и тремя --- для докторской.


## <span class="section-num">9</span> Направления исследований (пункты паспорта) {#направления-исследований--пункты-паспорта}


### <span class="section-num">9.1</span> Список по паспорту специальности {#список-по-паспорту-специальности}
...
### <span class="section-num">9.2</span> Пункт 1. Разработка новых математических методов моделирования объектов и явлений (физико-математические науки) {#пункт-1-dot-разработка-новых-математических-методов-моделирования-объектов-и-явлений--физико-математические-науки}

-   Создание теорий и подходов к описанию реальности на языке математики.


### <span class="section-num">9.3</span> Пункт 2. Разработка, обоснование и тестирование эффективных вычислительных методов с применением современных компьютерных технологий {#пункт-2-dot-разработка-обоснование-и-тестирование-эффективных-вычислительных-методов-с-применением-современных-компьютерных-технологий}

-   Как именно мы будем решать математические уравнения на компьютере.


### <span class="section-num">9.4</span> Пункт 3. Реализация эффективных численных методов и алгоритмов в виде комплексов проблемно-ориентированных программ для проведения вычислительного эксперимента {#пункт-3-dot-реализация-эффективных-численных-методов-и-алгоритмов-в-виде-комплексов-проблемно-ориентированных-программ-для-проведения-вычислительного-эксперимента}

-   Мало придумать метод, нужно превратить его в работающий код (программный комплекс).


### <span class="section-num">9.5</span> Пункт 4. Разработка новых математических методов и алгоритмов интерпретации натурного эксперимента на основе его математической модели {#пункт-4-dot-разработка-новых-математических-методов-и-алгоритмов-интерпретации-натурного-эксперимента-на-основе-его-математической-модели}

-   Как с помощью модели объяснить данные, полученные с реальной установки.


### <span class="section-num">9.6</span> Пункт 5. Разработка новых математических методов и алгоритмов валидации математических моделей объектов на основе данных натурного эксперимента или на основе анализа математических моделей {#пункт-5-dot-разработка-новых-математических-методов-и-алгоритмов-валидации-математических-моделей-объектов-на-основе-данных-натурного-эксперимента-или-на-основе-анализа-математических-моделей}

-   Валидация математической модели.


### <span class="section-num">9.7</span> Пункт 6. Разработка систем компьютерного и имитационного моделирования, алгоритмов и методов имитационного моделирования на основе анализа математических моделей (технические науки) {#пункт-6-dot-разработка-систем-компьютерного-и-имитационного-моделирования-алгоритмов-и-методов-имитационного-моделирования-на-основе-анализа-математических-моделей--технические-науки}
...
### <span class="section-num">9.8</span> Пункт 7. Качественные или аналитические методы исследования математических моделей (технические науки) {#пункт-7-dot-качественные-или-аналитические-методы-исследования-математических-моделей--технические-науки}

-   Изучение свойств модели без расчета на компьютере.


### <span class="section-num">9.9</span> Пункт 8. Комплексные исследования научных и технических проблем с применением современной технологии математического моделирования и вычислительного эксперимента {#пункт-8-dot-комплексные-исследования-научных-и-технических-проблем-с-применением-современной-технологии-математического-моделирования-и-вычислительного-эксперимента}

-   Применение всего арсенала (модель + метод + программа) для решения конкретной большой задачи.


### <span class="section-num">9.10</span> Пункт 9. Постановка и проведение численных экспериментов, статистический анализ их результатов, в том числе с применением современных компьютерных технологий (технические науки) {#пункт-9-dot-постановка-и-проведение-численных-экспериментов-статистический-анализ-их-результатов-в-том-числе-с-применением-современных-компьютерных-технологий--технические-науки}

-   Планирование расчетов и обработка их результатов.
