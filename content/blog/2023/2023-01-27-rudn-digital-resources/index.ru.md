...
lastmod: 2026-09-22T14:23:00+03:00
tags: ["rudn"]
categories: ["job"]
draft: false
...
-   В РУДН используется единая система аутентификации --- RUDN ID (<https://id.rudn.ru/sign-in>).
-   Смена пароля RUDN ID инициирует одновременную смену пароля во всех корпоративных ресурсах РУДН <https://id.rudn.ru/password/recovery>.
-   Максимальный срок действия пароля: 180 дней
-   Минимальная длина пароля: 9 знаков.
-   Максимальное количество символов, ограниченное системой при создании пароля: 48 знаков.
-   Сложность пароля: латинские буквы в разных регистрах, цифры, специальные символы.
-   При создании пароля ограничивается возможность использования паролей, использованных пользователем ранее в информационной системе: не менее 3 последних паролей.
...
-   Ссылка для смены пароля: <https://id.rudn.ru/password/recovery>.
-   Почта Единой технической поддержки: support@rudn.ru.
-   Тел: +7 (499) 936-87-77, +7 (495) 787-38-03 (27-77).
...
-   Список ресурсов РУДН: <https://www.rudn.ru/resources>.
...
-   Система обнаружения заимствований «Антиплагиат.РУДН»: <https://rudn.antiplagiat.ru/>.
-   Репозиторий РУДН: <https://repository.rudn.ru/>.
-   Клинико-диагностический центр (КДЦ) РУДН (Запись в КДЦ на приём к врачу): <https://clinic.rudn.ru/>.
-   Библиотека РУДН: <https://lib.rudn.ru/>.
-   Внутренняя база знаний Университета: <https://wiki.rudn.ru/>.
-   База знаний Университета (техническая поддержка): <https://wiki.yandex.ru/> (вход по корпоративной учётной записи).
-   Система тайного голосования «Времена года»: <https://seasons.rudn.ru/>
-   Сервисы Яндекс 360  (Почта, Диск, Телемост, Календарь, Мессенджер): <https://360.yandex.ru/>
