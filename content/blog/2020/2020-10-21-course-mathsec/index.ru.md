...
lastmod: 2026-03-31T20:15:00+03:00
...
#### <span class="section-num">2.1.3</span> Темы для РПД {#темы-для-рпд}
...
### <span class="section-num">3.2</span> План разработки {#план-разработки}
...
## <span class="section-num">6</span> Литература по курсу {#литература-по-курсу}
...
#### <span class="section-num">7.1.1</span> Лабораторные работы {#лабораторные-работы}
...
#### <span class="section-num">7.1.2</span> Список элементов (чек-лист) для лабораторных работ {#список-элементов--чек-лист--для-лабораторных-работ}
...
## <span class="section-num">8</span> Оценивание {#оценивание}
...
### <span class="section-num">9.1</span> Запись занятий {#запись-занятий}
...
-   [Телемост: Математические основы защиты информации и информационной безопасности](https://telemost.yandex.ru/j/5575733616)


### <span class="section-num">9.2</span> Материалы курса {#материалы-курса}

-   [Rutube: Математические основы защиты информации и информационной безопасности](https://rutube.ru/plst/1174600)
-   [VKvideo: Математические основы защиты информации и информационной безопасности](https://vkvideo.ru/playlist/606414976_16)
-   [Платформа: Математические основы защиты информации и информационной безопасности](https://plvideo.ru/playlist?list=oo4vJga7BfMs)
-   [Youtube: Математические основы защиты информации и информационной безопасности](https://www.youtube.com/playlist?list=PLhyPdV6jkp-R3EaccJ4fOeA7siZ2T0LO5)
