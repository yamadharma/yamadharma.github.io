...
lastmod: 2026-04-30T20:51:00+03:00
tags: ["rudn", "education"]
...
## <span class="section-num">6</span> Для СЭД {#для-сэд}


### <span class="section-num">6.1</span> Подготовка стенда {#подготовка-стенда}


#### <span class="section-num">6.1.1</span> Подготовка стенда {#подготовка-стенда}
...
#### <span class="section-num">6.1.2</span> Основные модели {#основные-модели}
...
### <span class="section-num">6.2</span> Агентное моделирование {#агентное-моделирование}


#### <span class="section-num">6.2.1</span> Агентное моделирование {#агентное-моделирование}
...
#### <span class="section-num">6.2.2</span> Реализация основных моделей в агентном подходе {#реализация-основных-моделей-в-агентном-подходе}
...
### <span class="section-num">6.3</span> Аппарат сетей Петри {#аппарат-сетей-петри}


#### <span class="section-num">6.3.1</span> Аппарат сетей Петри {#аппарат-сетей-петри}
...
#### <span class="section-num">6.3.2</span> Реализация основных моделей в подходе сетей Петри {#реализация-основных-моделей-в-подходе-сетей-петри}
...
### <span class="section-num">6.4</span> Дискретно-событийное моделирование {#дискретно-событийное-моделирование}


#### <span class="section-num">6.4.1</span> Дискретно-событийное моделирование {#дискретно-событийное-моделирование}
...
#### <span class="section-num">6.4.2</span> Реализация основных моделей в дискретно-событийном подходе {#реализация-основных-моделей-в-дискретно-событийном-подходе}
